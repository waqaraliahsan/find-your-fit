 ...
 * Applies global styles and renders a minimal header used across the app.
 * Keep this file at app/layout.tsx so Vercel has a proper root.
 */
        ...
        <header className="bg-white border-b">
          <div className="container flex items-center justify-between py-3">
            ...
            <nav className="flex items-center gap-3">
              ...
              <Link
                href="/admin"
                className="px-3 py-1.5 rounded-md border hover:bg-white"
